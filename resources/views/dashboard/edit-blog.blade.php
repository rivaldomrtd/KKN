...
<x-app-layout>
    ...
    <table>
        <tr>
            ...
            @endif
            <td> <img valign="top" class="rounded-btn w-80 h-50 " src="/image/{{ $blog->image }}" alt=""></td>
            <td><form class="max-w-screen-lg" method="POST" action="{{ route('blog.update', $blog->id ) }}" enctype="multipart/form-data">
                @csrf
                @method('PUT')
