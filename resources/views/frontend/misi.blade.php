                ...
                <ol class="inline-flex items-center space-x-1 md:space-x-3">
                    ...
                    <li>
                        <div class="flex items-center">
                            ...
                            <a href="/profile"
                                class="ml-1 text-sm font-medium text-gray-700 hover:text-gray-900 md:ml-2 dark:text-gray-400 dark:hover:text-white">Visi
                                & Misi</a>
                        </div>
                    </li>
                </ol>
                ...
                <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mb-10">
                    <div class="lg:text-center">
                        ...
                        @forelse ($misi as $misi)
                            <img class="inline-block h-60 w-60 rounded-full ring-2 ring-white"
                                src="/image/{{ $misi->image }}" alt="">
