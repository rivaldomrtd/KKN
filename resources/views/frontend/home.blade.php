...
@section('content')
    @foreach ($home as $home)
        <div id="home" class="header-hero" style="background-image: url(images/backgrnd.jpg)">
            <div class="container">
                <div class="justify-center row">
                  ...
                  "
                            ...
                            <a href="#features" class="page-scroll main-btn gradient-btn gradient-btn-2 wow fadeInUp"
            ...
            <div class="justify-center row">
                <div class="w-full lg:w-2/3">
                    <div class="pb-10 text-center section-title">
                        ...
                        <h3 class="title">Karangpilang, <span> Kecamatan Karangpilang terkenal sebagai kawasan industri di
                                Surabaya Selatan.</span></h3>
                    </div> <!-- section title -->
                </div>
            </div> <!-- row -->
            <div class="justify-center row ">
                    ...
                    <div class="w-full sm:w-2/3 lg:w-1/3 ">
                        <div class="mt-8 text-center single-services wow fadeIn" data-wow-duration="1s"
                            ...
                            <div class="services-icon">
                                <img class="shape" src="/image/{{ $card->image }}" alt="shape" width="77"
                                    height="77">
                            </div>
    ...
    <footer id="footer" class="relative z-10 footer-area pt-120">
        <div class="footer-bg" style="background-image: url({{ url('images/backgrnd2.jpg') }})"></div>
        <div class="container">
            <div class="
            px-4
            pt-2
