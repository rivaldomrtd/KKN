                ...
                <ol class="inline-flex items-center space-x-1 md:space-x-3">
                    ...
                    <li>
                        <div class="flex items-center">
                            ...
                            <a href="/gallery"
                                class="ml-1 text-sm font-medium text-gray-700 hover:text-gray-900 md:ml-2 dark:text-gray-400 dark:hover:text-white">Gallery</a>
                        </div>
                    </li>
                </ol>
            </nav>
            ...
            <div class="justify-center row">
                <div class="w-full lg:w-2/3">
                    <div class="pb-8 text-center section-title">
                        ...
                        <span class="mt-4"><a href="/gallery" class="text-blue-500 btn">Photos</a> | <a
                                href="/gallery/videos" class="text-blue-700 font-bold ">Videos</a> </span>
                    </div>
